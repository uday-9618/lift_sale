      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        children: [Text("60%", style: TextStyle(fontSize: 15))],
                      ),
                    ],
                  ),
                  SizedBox(height: 10),
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          children: [
                            Text(
                              "payment received via check #12345",
                              style: TextStyle(fontSize: 15),
                            ),
                          ],
                        ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Prakash Tower 15th floor,Bandra Kurla",
                    style: TextStyle(fontSize: 15, color: Colors.black),
                  ),
                  Text(
                    "Complex,Mumbai,Maharastra,400051",
                    style: TextStyle(fontSize: 15, color: Colors.black),
                  ),
                  SizedBox(height: 20),
                  Text(
                  ...
                  SizedBox(height: 10),
                  Text(
                    "Access through service entrance.contact",
                    style: TextStyle(fontSize: 15, color: Colors.black),
                  ),
                  Text(
                    "site manager (Rahul) at 9876543210 before",
                    style: TextStyle(fontSize: 15, color: Colors.black),
                  ),
                  Text(
                    "arrival.Elevator shaft preparation completed.",
                    style: TextStyle(fontSize: 15, color: Colors.black),
                  ),
                  Text(
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: Icon(Icons.today, color: Colors.lightGreen),
                      ),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
            ...
            Container(
              height: 700,
              width: double.infinity, //color: Colors.blueGrey,
              margin: EdgeInsets.all(16),
              decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: BorderRadius.circular(20),
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Row(children: [Icon(Icons.insert_drive_file)]),
                        ),
                        Row(
                          children: [
                            Padding(
